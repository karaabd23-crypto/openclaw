...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.planningModel": "Planning Model",
  "agents.defaults.planningModel.primary": "Planning Model",
  "agents.defaults.planningModel.fallbacks": "Planning Model Fallbacks",
  ...
  "agents.defaults.embeddedPi.criticLoop": "Embedded Pi Critic Loop",
  "agents.defaults.embeddedPi.criticLoop.enabled": "Embedded Pi Critic Loop Enabled",
  "agents.defaults.embeddedPi.criticLoop.maxRevisions": "Embedded Pi Critic Loop Max Revisions",
  "agents.defaults.embeddedPi.criticLoop.runOnTriggers": "Embedded Pi Critic Loop Triggers",
  "agents.defaults.embeddedPi.criticLoop.runOnTaskKinds": "Embedded Pi Critic Loop Task Kinds",
  "agents.defaults.embeddedPi.criticLoop.requireValidation":
    "Embedded Pi Critic Loop Require Validation",
  "agents.defaults.embeddedPi.criticLoop.diagnostics": "Embedded Pi Critic Loop Diagnostics",
  ...
  "agents.list[].embeddedPi.criticLoop": "Agent Critic Loop",
  "agents.list[].embeddedPi.criticLoop.enabled": "Agent Critic Loop Enabled",
  "agents.list[].embeddedPi.criticLoop.maxRevisions": "Agent Critic Loop Max Revisions",
  "agents.list[].embeddedPi.criticLoop.runOnTriggers": "Agent Critic Loop Triggers",
  "agents.list[].embeddedPi.criticLoop.runOnTaskKinds": "Agent Critic Loop Task Kinds",
  "agents.list[].embeddedPi.criticLoop.requireValidation": "Agent Critic Loop Require Validation",
  "agents.list[].embeddedPi.criticLoop.diagnostics": "Agent Critic Loop Diagnostics",
